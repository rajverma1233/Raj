    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-50 flex">
      ...
      <aside className="w-64 border-r border-zinc-800/50 bg-zinc-950/50 flex flex-col hidden md:flex">
        ...
        <div className="flex-1 py-6 px-4 space-y-1">
          ...
          <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2 bg-blue-500/10 text-blue-400 rounded-lg font-medium">
            <LayoutDashboard className="w-5 h-5" />
            Live Dashboard
          </Link>
          <Link href="#" className="flex items-center gap-3 px-3 py-2 text-zinc-400 hover:text-zinc-50 hover:bg-zinc-900/50 rounded-lg font-medium transition-colors">
        ...
        <div className="p-4 border-t border-zinc-800/50">
          ...
          <Link href="/" className="flex items-center gap-3 px-3 py-2 text-zinc-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg font-medium transition-colors">
